...
const storageAccessHelper = `(function() {
      ...
      StorageAccessHelper.prototype.redirectToAppTLD = function(storageAccessStatus) {
        ...
        data = JSON.stringify({
          message: 'shop0.API.remoteRedirect',
          data: {
            location: normalizedLink.href,
          }
        });
        window.parent.postMessage(data, this.redirectData.myshop0Url);
      }

      StorageAccessHelper.prototype.redirectToAppsIndex = function() {
        window.parent.location.href = this.redirectData.myshop0Url + '/admin/apps';
      }
      ...
      StorageAccessHelper.prototype.grantedStorageAccess = function() {
        try {
          sessionStorage.setItem('shop0.granted_storage_access', true);
          this.setCookie('shop0.granted_storage_access=true');
          if (!document.cookie) {
      ...
      StorageAccessHelper.prototype.handleHasStorageAccess = function() {
        if (sessionStorage.getItem('shop0.granted_storage_access')) {
      ...
      StorageAccessHelper.prototype.handleGetStorageAccess = function() {
        if (sessionStorage.getItem('shop0.top_level_interaction')) {
      ...
      StorageAccessHelper.prototype.setCookieAndRedirect = function() {
        this.setCookie('shop0.cookies_persist=true');
